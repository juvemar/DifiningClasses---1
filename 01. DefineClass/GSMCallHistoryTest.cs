...
namespace Mobile
{
    public class GSMCallHistoryTest
    {
        ...
        static GSM phone = new GSM("K800", "Sony Ericsson", 300, "Ganio", new Display(3, 5),
                                new Battery("MI250", 150, 300, BatteryType.LiIon));
        static Call firstCall = new Call(new DateTime(2014, 3, 1, 3, 30, 45), "0888343434", 123123);
        static Call secondCall = new Call(new DateTime(2014, 4, 2, 2, 15, 34), "0888243644", 110243);
        static Call thirdCall = new Call(new DateTime(2014, 3, 8, 9, 23, 2), "0888353476", 115032);
        ...
        public Call DeleteLongestCall(GSM phone)
        {
            ...
            return phone.CallHistory[toBeDeleted];
        }
